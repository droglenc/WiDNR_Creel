...
table4 <- function(fnpre,rmvFISHERYS="") {
  ...
  tmp <- read.csv(paste0(fnpre,"ttlEffort.csv")) %>%
    ...
    ## Remove repeated items in the first three variables
    dplyr::mutate(WATERS=iRemoveRepeatLabels(.,"WATERS"),
                  FISHERY=iRemoveRepeatLabels(.,"FISHERY","WATERS"),
                  MONTH=iRemoveRepeatLabels(.,"MONTH",c("WATERS","FISHERY"))) %>%
...
```{r figure1, eval=MAKE_FIGURES, fig.width=5, fig.height=3.5}
figure1 <- function(d) {
  tmp <- d %>%
...
```{r figure2, eval=MAKE_FIGURES, fig.width=5, fig.height=5}
...
```{r figure3, eval=MAKE_FIGURES, fig.width=5, fig.height=3.5}
figure3 <- function(d) {
  tmp <- d %>%
...
```{r figure4, eval=MAKE_FIGURES, fig.width=5}
...
```{r figure5, eval=MAKE_FIGURES, fig.width=5, fig.height=3.5}
