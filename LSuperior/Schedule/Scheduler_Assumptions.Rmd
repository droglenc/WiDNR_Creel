...
1. Each clerk will have two consecutive weekdays off each week during the "open-water" months. The same two weekdays will not be off for consecutive weeks.
